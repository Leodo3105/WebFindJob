            ...
            <section className="xl:bg-cover bg-top bg-no-repeat hero-2 -mt-24 pt-24 w-full">
                <div className="container px-4 mx-auto">
                    <div className="pt-12 text-center">
                        ...
                        <div>
                            <Link className="btn bg-primary-500   rounded-full text-white py-4 px-8 mr-2 wow animate__ animate__fadeInUp hover-up-2 animated" href="https://doc.imsaifun.com/prexjob.html" target="_blank">Documentation</Link>
                        </div>
                    </div>
                </div>
            </section>
