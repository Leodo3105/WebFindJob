        ...
        <>
            <div className="group">
                <div className="relative px-6 pt-5 pb-5 rounded-xl bg-primary-50/50 group-hover:bg-primary-500 transition duration-150 wow animate__animated animate__fadeInUp">
                    ...
                    <div className="my-3">
                        <span className='bg-primary-50  shadow-sm text-xs px-3 py-1 rounded-xl mr-2 text-primary-500 capitalize'>{item.JobType.name}</span>
                    ...
                    <div className="flex items-center justify-between mt-5">
                        <div className="flex items-center group-hover:text-pgray-50">
                            <Icon.Clock />
                            <span className='ml-2 text-sm text-gray-500 group-hover:text-pgray-300'>{formatDistanceToNow(new Date(item.updated_at), { addSuffix: true })}</span>
                        </div>
